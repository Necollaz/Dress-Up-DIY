...
{
    [CreateAssetMenu(fileName = "MakeupMotionSettings", menuName = "Project/Gameplay/Makeup/MakeupMotionSettings")]
    public sealed class MakeupMotionSettings : ScriptableObject
    {
        ...
        [SerializeField] private AnimationCurve _automaticMoveCurve =
